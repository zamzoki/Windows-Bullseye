...
namespace BullseyeCursors.Models
{
    public class Cursor
    {
        ...
        private void DrawTrack()
            => this.cursorGraphics.Clear(Theme.CursorTrack);
        ...
        private void DrawCursorForHorizontalTrack()
            => this.cursorGraphics.FillRectangle(new SolidBrush(Theme.Cursor), this.Coordinate, 0, CursorThickness, this.height);

        private void DrawCursorForVerticalTrack()
            => this.cursorGraphics.FillRectangle(new SolidBrush(Theme.Cursor), 0, this.Coordinate, this.width, CursorThickness);
